...
def override_config_with_args(cfg, return_nested=True):
    ...
    # general
    parser.add_argument(
        "--general__seed", type=int, default=cfg.general.seed, help="seed"
    )
    parser.add_argument(
        "--general__device", type=int, default=cfg.general.device, help="device"
    )

    # data
    parser.add_argument("--data__name", type=str, default=cfg.data.name, help="name")
    ...
    # data -> preprocess
    parser.add_argument(
        "--data__preprocess__max_dis",
        type=int,
        default=cfg.data.preprocess.max_dis,
        help="max_dis",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=cfg.data.sampling.keep_subgraph_prob,
        help="keep_subgraph_prob",
    )
    parser.add_argument(
        "--data__sampling__average_res_over",
        type=int,
        default=cfg.data.sampling.average_res_over,
        help="data__average_res_over",
    )

    # model
    parser.add_argument(
        "--model__residual", type=str2bool, default=cfg.model.residual, help="residual"
    )
    parser.add_argument("--model__aggs", type=list, default=cfg.model.aggs, help="aggs")
    parser.add_argument(
        "--model__sum_pooling",
        type=str2bool,
        default=cfg.model.sum_pooling,
        help="sum_pooling",
    )

    parser.add_argument(
        "--model__model_name", type=str, default=cfg.model.model_name, help="model_name"
    )
    parser.add_argument(
        "--model__num_layer", type=int, default=cfg.model.num_layer, help="num_layer"
    )
    parser.add_argument(
        "--model__dim_embed", type=int, default=cfg.model.dim_embed, help="dim_embed"
    )
    parser.add_argument(
        "--model__final_dim", type=int, default=cfg.model.final_dim, help="final_dim"
    )
    parser.add_argument(
        "--model__dropout", type=float, default=cfg.model.dropout, help="dropout"
    )
    parser.add_argument(
        "--model__attention_type",
        type=str,
        default=cfg.model.attention_type,
        help="attention_type",
    )
    parser.add_argument("--model__H", type=int, default=cfg.model.H, help="H")
    # model -> PE
    parser.add_argument(
        "--model__PE__num_eigen_vectors",
        type=int,
        default=cfg.model.PE.num_eigen_vectors,
        help="num_eigen_vectors",
    )
    parser.add_argument(
        "--model__PE__laplacian_type",
        type=str,
        default=cfg.model.PE.laplacian_type,
        help="laplacian_type",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=cfg.model.atom_encoder.in_dim,
        help="atom_encoder_in_dim",
    )
    parser.add_argument(
        "--model__atom_encoder__linear",
        type=str2bool,
        default=cfg.model.atom_encoder.linear,
        help="atom_encoder_linear",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=cfg.model.edge_encoder.in_dim,
        help="edge_encoder_in_dim",
    )
    parser.add_argument(
        "--model__edge_encoder__linear",
        type=str2bool,
        default=cfg.model.edge_encoder.linear,
        help="edge_encoder_linear",
    )
    parser.add_argument(
        "--model__edge_encoder__use_edge_attr",
        type=str2bool,
        default=cfg.model.edge_encoder.use_edge_attr,
        help="edge_encoder_use_edge_attr",
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=cfg.model.layer_encoder.linear,
        help="layer_encoder_linear",
    )

    # training
    parser.add_argument(
        "--training__lr", type=float, default=cfg.training.lr, help="lr"
    )
    parser.add_argument(
        "--training__wd", type=float, default=cfg.training.wd, help="wd"
    )
    parser.add_argument(
        "--training__epochs", type=int, default=cfg.training.epochs, help="epochs"
    )
    parser.add_argument(
        "--training__patience", type=int, default=cfg.training.patience, help="patience"
    )
    ...
    parser.add_argument(
        "--wandb__project_name",
        type=str,
        default=cfg.wandb.project_name,
        help="project_name",
    )
    # ================================================================================================ #
    # ================================================================================================ #
